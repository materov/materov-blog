...
knitr::include_url("BasicMap.html", height="500px")
```
...
```{r, out.width="100%", echo=FALSE}
knitr::include_url("ZeroMap.html", height="500px")
```
...
```{r, out.width="100%", echo=FALSE}
knitr::include_url("AddMarkersMap.html", height="500px")
```
...
```{r, out.width="100%", echo=FALSE}
knitr::include_url("AddClustersMap.html", height="500px")
```
...
```{r, out.width="100%", echo=FALSE}
knitr::include_url("AddAwesomeMarkers.html", height="500px")
```
...
```{r, out.width="100%", echo=FALSE}
knitr::include_url("SquareMarkers.html", height="500px")
```
...
```{r, out.width="100%", echo=FALSE}
knitr::include_url("Add_Legend.html", height="500px")
```
