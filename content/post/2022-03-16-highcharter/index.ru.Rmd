...
```{r echo=FALSE, message=FALSE, warning=FALSE}
saveWidget(file = "map_cities.html",
  hcmap("countries/ru/custom/ru-all-disputed", showInLegend = FALSE) %>% 
  hc_add_series(
    data = cities_300, 
    type = "mappoint",
...
knitr::include_url("map_cities.html", height = "500px")
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
saveWidget(file = "map_world.html", hcmap(
  "custom/world-robinson-lowres", 
  data = AverageTemperature,
  name = "температура", 
  value = "aveT",
...
knitr::include_url("map_world.html", height = "500px")
```
...
knitr::include_url("AAPL.html", height = "500px")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
saveWidget(file = "drilldown.html", 
hchart(fire_column,
       "column",
       hcaes(
         x         = type_name,
...
knitr::include_url("drilldown.html", height = "500px")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
saveWidget(file = "weather_base.html", 
hc_weather %>%
  hc_add_theme(hc_theme_smpl())
)

knitr::include_url("weather_base.html", height = "500px")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
saveWidget(file = "weather_google.html", 
hc_weather %>%
  hc_add_theme(hc_theme_google())
)

knitr::include_url("weather_google.html", height = "500px")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
saveWidget(file = "weather_538.html", 
hc_weather %>%
  hc_add_theme(hc_theme_538())
)

knitr::include_url("weather_538.html", height = "500px")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
saveWidget(file = "weather_3D.html", 
# 3D-версия диаграммы
hc %>% 
  hc_chart(
    type = "column",
...
knitr::include_url("weather_3D.html", height = "500px")
```
