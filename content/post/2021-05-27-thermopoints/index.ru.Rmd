...
# Исследование термоточек зарегистрированных в РФ
...
```{r lonlatmax, warning=FALSE, message=FALSE, fig.cap = "*Широта и долгота, на которых наблюдалось наибольшее количество термоточек*", fig.height = 5, fig.width = 9}
# долгота
df %>% 
...
```{r hexmapbyyear, warning=FALSE, message=FALSE, fig.cap = "*Распеределение термоточек по годам*", fig.height = 7, fig.width = 10}
df %>% 
  ggplot(aes(lon, lat)) + 
  borders("world", regions = "Russia", fill = "grey80") +
...
Рассмотрим распеределение термоточек по месяцам, например, для лесных и природных пожаров.

```{r hexmapbymonth, warning=FALSE, message=FALSE, fig.cap = "*Распеределение термоточек по месяцам для лесных и природных пожаров*", fig.height = 7, fig.width = 10}
df %>% 
...
Рассмотрим распеределение термоточек по категориям.

```{r hexmapbytype, warning=FALSE, message=FALSE, fig.cap = "*Распеределение термоточек по категориям.*", fig.height = 7, fig.width = 10}
df %>% 
  ggplot(aes(lon, lat)) + 
  borders("world", regions = "Russia", fill = "grey80") +
  geom_hex(alpha = 0.7, bins = 50) +
